...
\begin{frame}{}
CsgC was reported to effectively inhibit CsgA aggregation. \textit{In vivo}, it prevents CsgA from aggregating within the periplasm~\citep{evans_bacterial_2015}.
